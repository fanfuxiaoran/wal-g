...
func getDeltaMap(reader internal.StorageFolderReader,
	...
	/*
     * Check first delta file if eixsts, if not, parse it from wal log
...
func getWalSegmentRangeForDelta(fisrtUsedLsn LSN, firstNotUsedLsn LSN) (WalSegmentNo, WalSegmentNo){
